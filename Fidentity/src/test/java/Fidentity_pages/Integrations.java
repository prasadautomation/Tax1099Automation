...
import Object_repo.Integrationrepo;
...
public class Integrations extends Fid_base {
	...
	public void integrationsnav() {
		...
		settingsiconexe.executeScript("arguments[0].click();", Integrationrepo.settingsicon);
	...
	public void gsuiteenable() throws InterruptedException {
		...
		// String
		// status=driver.findElement(By.xpath("//div[@id='gsuite']//div//span//a[contains(text(),'Enable')]")).getAttribute("innerHTML");
		// System.out.println(" Stautus -- "+status);

		String status = driver.findElement(By.xpath("//div[@id='gst_directory']//a[@class='waves-effect waves-light']"))
		...
		if (status.equals("Enable")) {
			...
			driver.findElement(By.xpath(
					"//div[@id='gsuite_confirmation_help']//div[@class='modal-footer']//a[contains(text(),'Proceed')]"))
					.click();
		...
		//// div[@id='gsuite']/parent::div[@class='card
		//// sticky-action']/following-sibling::div[@class='card
		//// sticky-action']/child::div[@class='card-content']
	}

	public void activeDirectory() {
		// driver.findElement(By.xpath("div[@id='gsuite']/parent::div[@class='card
		// sticky-action']/following-sibling::div[@class='card
		// sticky-action']/child::div[@class='card-content']")).click();
		String status = driver.findElement(By.xpath("//div[@id='act_directory']//a[@class='waves-effect waves-light']"))
				.getAttribute("innerHTML");
...
//	driver.findElement(By.xpath("//div//span//a[contains(text(),'View Employees')]")).click();
		WebElement element2 = driver
				.findElement(By.xpath("//div[@id='service_user_features']//a[contains(text(),'View Employees')]"));

		Actions actions2 = new Actions(driver);

		actions2.moveToElement(element2).click(element2).build().perform();
		String lastsyndate = driver
				.findElement(By.xpath(
						"//div[@class='integration-note ng-binding'] and [contains(text(),'Gsuite last sync:  ')]"))
				.getText();
