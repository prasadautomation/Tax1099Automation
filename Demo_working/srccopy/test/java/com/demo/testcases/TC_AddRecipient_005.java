...
public class TC_AddRecipient_005 extends base {
	...
	@Test(priority = 2, dataProvider="addrecipientrandombusinessein", dataProviderClass = DataProviders.class )
	public void addRecipientEin(HashMap<String, String> hashMapValue) throws Throwable {
...
WebElement businessname=getDriver().findElement(By.id("PayeeLastName"));
	...
	/*	ManagePayerAddPayer.AddrecipientrandombusinessEIN(
			...
			Thread.sleep(2000);
			getDriver().findElement(By.id("alertify-resetFocus")).click();
	...
	public void addRecipientEin(HashMap<String, String> hashMapValue) throws Throwable {
		...
		WebElement addrecipient=getDriver().findElement(By.xpath("//input[@id='btnAddPayee']"));
		addrecipient.click();
		Thread.sleep(10000);
		Log.info("Add recipient button clicked ");}*/
	...
	/*	getDriver().findElement(By.xpath("//input[@id='rblPayeeType']")).click();
		...
		ManagePayerAddPayer.AddpayerrandombusinessEIN(
			...
			//	hashMapValue.get("einTIN"),
				...
				// hashMapValue.get("MiddleName"),
				 //hashMapValue.get("LastName"),
			//	hashMapValue.get("businessname"), 
				hashMapValue.get("address"), hashMapValue.get("suffix"),
		...
		getDriver().findElement(By.id("PayeeZIP")).clear();
		getDriver().findElement(By.id("PayeeZIP")).click();
		getDriver().findElement(By.id("PayeeZIP")).sendKeys("35010");
