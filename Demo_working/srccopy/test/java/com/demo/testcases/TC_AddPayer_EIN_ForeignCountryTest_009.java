...
public class TC_AddPayer_EIN_ForeignCountryTest_009 extends base {
	LoginPage LoginPage;
	...
	@Test(priority = 2, dataProvider = "addpayernonusein", dataProviderClass = DataProviders.class)
	public void AddpayerEINcountryNONUs(HashMap<String, String> hashMapValue) throws Throwable  {
		
		
		Log.startTestCase("AddSSAddpayerEINcountryNONUsNPayer");
