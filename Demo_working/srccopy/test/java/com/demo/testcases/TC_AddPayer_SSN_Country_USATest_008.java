...
public class TC_AddPayer_SSN_Country_USATest_008 extends base {
	...
	public void AddSSNPayer(HashMap<String, String> hashMapValue) throws Throwable {
		
			Log.startTestCase("AddSSNPayer");
		...
		Log.info("People menu clicked");
			...
			WebElement type=getDriver().findElement(By.xpath("//div[@id='divFederalIdTypeForAllForms']//input[@id='rblPayerTypeIndividual']"));
			type.click();
			Thread.sleep(10000);
