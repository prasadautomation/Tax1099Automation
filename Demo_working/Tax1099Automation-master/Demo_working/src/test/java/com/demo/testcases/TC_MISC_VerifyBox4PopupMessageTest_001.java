...
public class TC_MISC_VerifyBox4PopupMessageTest_001 extends base {
...
WebElement businessname=getDriver().findElement(By.id("PayeeLastName"));
	...
	@Test(priority=5)
	public void form_box4_popUp() throws Throwable {
		
		getDriver().manage().timeouts().implicitlyWait(50,TimeUnit.SECONDS);
		getDriver().findElement(By.xpath("//input[@id='FederalIncomeTaxWH']")).clear();
		getDriver().findElement(By.xpath("//input[@id='FederalIncomeTaxWH']")).sendKeys("10");
		Log.info("Box4 value enetered-10");
		Thread.sleep(50000);
