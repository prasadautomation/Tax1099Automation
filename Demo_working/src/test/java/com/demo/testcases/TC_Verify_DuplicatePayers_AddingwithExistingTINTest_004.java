...
public class TC_Verify_DuplicatePayers_AddingwithExistingTINTest_004 extends base{
	...
	@Test(priority=2)
	public void  duplicateCheckAddpayer() throws Throwable {
		
		//--------navigate to add payer-----//
		
		Log.startTestCase("duplicateCheckAddpayer");
		...
		WebElement element1 = (new WebDriverWait(getDriver(), 50))
