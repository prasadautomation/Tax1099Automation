...
import com.demo.actiondriver.Action;
	...
	public class MISC2020Form extends base{
		 ...
		 MISCformTaxyear2020 MISCformTaxyear2020;
...
//			  wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(text()='Dashboard')]")));
		...
		@Test(priority = 2,dataProvider ="MISC2020",dataProviderClass = DataProviders.class)
		public void CreateMISC2020FormTest1(HashMap<String,String> hashMapValue) throws Throwable {
			Log.startTestCase("CreateMISC2020FormTest1");
			FormsLeftMenu.ClickOnForms();
			FormsLeftMenu.ClickOnNewForm();
			MISCformTaxyear2020.CreateMISC2020Form(
					...
					hashMapValue.get("Box17StateNum1"),
					hashMapValue.get("Box17StateNum2"),
